...
- ![Image](assets/metal-slug-letter-a.png) Metal Slug (save to Slack as `metal-slug-*`): [TBD]
- ![Image](assets/slime-letter-a.png) Slime (save to Slack as `slime-*`): [TBD]
- ![Image](assets/janky-letter-a.png) Janky (save to Slack as `janky-*`): [TBD]
- ![Image](assets/doom-letter-a.png) Doom (save to Slack as `doom-*`): [TBD]
- ![Image](assets/mario-pinball-letter-a.png) Mario Pinball (save to Slack as `mario-pinball-*`): [TBD]
- ![Image](assets/dk64-letter-a.png) Donkey Kong 64 (save to Slack as `dk64-letter-*`): [TBD]
- ![Image](assets/pacman-letter-a.png) Pac-Man (save to Slack as `pacman-*`): [TBD]
