...
- ![Image](assets/plasma-letter-a.gif) Plasma Letters (save to Slack as `plasma-letter-*`): [source](https://emoji.gg/pack/1965-animated-alphabet)
- ![Image](assets/hellokitty-letter-a.png) Hello Kitty Letters (save to slack as `hellokitty-letter-*`): [source](https://emoji.gg/pack/78818-hello-kitty-letters-a-z)
- ![Image](assets/neon-letter-a.gif) Neon Letters (save to Slack as `neon-letter-*`): [source](https://emoji.gg/pack/7068-neonletters)
...
- ![Image](assets/magazine-letter-a.png) Magazine Cutout Letters (save to Slack as `magazine-letter-*`): [source](https://quintussential.com/archive/2021/06/14/Cut-Out-Letters-for-Slack/)
- ![Image](assets/dancing-letter-a.gif) Dancing Letters (save to Slack as `dancing-letter-*`): [source](https://tenor.com/search/dancing-letter-gifs)
...
- ![Image](assets/doom-letter-a.png) Doom (save to Slack as `doom-letter-*`): [source](https://c.eev.ee/doom-text-generator/)
